module.exports = async (req, res) => {
    ...
    Temos 4 fragrâncias para o produto "Passa Fácil Casa Guimarães":
    1. lavanda (Lavanda e Rosas Brancas - Calma, relaxante, paz, banho limpo)
    2. coco (Coco & Amêndoas - Conforto, abraço, aconchego, baunilha)
    3. orchid (Rosas Intensas - Elegância, luxo, poder, sofisticação)
    4. brisa (Carinho e Conforto - Frescor natural, brisa de ar puro, natureza)

    Retorne um JSON estrito no seguinte formato:
    {
       "fragranceKey": "uma das 4 chaves acima",
